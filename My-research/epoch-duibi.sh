...
python -m src.main --configs src/configs/dpjdg/dpjdg_pu_T2_1-1.yaml
python -m src.main --configs src/configs/dpjdg/dpjdg_pu_T2_5-1.yaml
python -m src.main --configs src/configs/erm/erm_pu_T2_1-1.yaml
python -m src.main --configs src/configs/erm/erm_pu_T2_5-1.yaml
python -m src.main --configs src/configs/masfd/masfd_pu_T2_1-1.yaml
python -m src.main --configs src/configs/masfd/masfd_pu_T2_5-1.yaml
python -m src.main --configs src/configs/mldg/mldg_pu_T2_1-1.yaml
python -m src.main --configs src/configs/mldg/mldg_pu_T2_5-1.yaml
python -m src.main --configs src/configs/sdagn/sdagn_pu_T2_1-1.yaml
python -m src.main --configs src/configs/sdagn/sdagn_pu_T2_5-1.yaml
python -m src.main --configs src/configs/vrex/vrex_pu_T2_1-1.yaml
python -m src.main --configs src/configs/vrex/vrex_pu_T2_5-1.yaml
