...
class Controller:
    ...
    def set_app_walking_param_callback(self, msg):
        ...
        self.walking_param['pelvis_offset'] = 0
        ...
        if msg.speed == 4:
            ...
            self.walking_param['y_swap_amplitude'] = 0
            self.walking_param['z_swap_amplitude'] = 0.003
            self.walking_param['pelvis_offset'] = 0
            ...
            if self.walking_param['x_move_amplitude'] != 0:
                ...
                if self.walking_param['x_move_amplitude'] > 0:
                    self.walking_param['angle_move_amplitude'] += 2
                else:
                    self.walking_param['angle_move_amplitude'] += -0.65
            ...
            if self.walking_param['y_move_amplitude'] != 0 and self.walking_param['x_move_amplitude'] == 0 and self.walking_param['angle_move_amplitude'] == 0:
                ...
                if self.walking_param['y_move_amplitude'] > 0:
                    self.walking_param['angle_move_amplitude'] += 2.76
                else:
                    self.walking_param['angle_move_amplitude'] += --0.8
