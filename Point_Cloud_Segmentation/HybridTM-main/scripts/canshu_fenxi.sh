...
# angle_weight=1.0（基准）
sh scripts/train.sh -g 1 -d scannet -c semseg-oacnns-TopoFusion-ABC_angle2.0 -n semseg-oacnns-TopoFusion-ABC_angle2.0-newdata

# angle_weight=1.1（基准）
sh scripts/train.sh -g 1 -d scannet -c semseg-oacnns-TopoFusion-ABC_angle2.5 -n semseg-oacnns-TopoFusion-ABC_angle2.5-newdata

# angle_weight=1.2（基准）
sh scripts/train.sh -g 1 -d scannet -c semseg-oacnns-TopoFusion-ABC_angle3.0 -n semseg-oacnns-TopoFusion-ABC_angle3.0-newdata

# angle_weight=1.3（基准）
sh scripts/train.sh -g 1 -d scannet -c semseg-oacnns-TopoFusion-ABC_angle3.5 -n semseg-oacnns-TopoFusion-ABC_angle3.5-newdata

# angle_weight=1.4（基准）
sh scripts/train.sh -g 1 -d scannet -c semseg-oacnns-TopoFusion-ABC_angle4.0 -n semseg-oacnns-TopoFusion-ABC_angle4.0-newdata
